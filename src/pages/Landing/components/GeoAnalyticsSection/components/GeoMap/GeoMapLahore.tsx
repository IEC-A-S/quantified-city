...
export const GeoMapLahore: FC<GeoMapProps> = ({ setMap, isMobile }) => {
  //Init params for map
  ...
  useEffect(() => {
    ...
    map.current.on("load", () => {
      ...
      map.current.addSource("build_up", {
        type: "raster",
        url: "mapbox://stanronzhin.02w2ec6e",
      });
      ...
      map.current.addSource("pop_raster", {
        type: "raster",
        url: "mapbox://stanronzhin.2fvephbz",
      });
      ...
      map.current.addSource("pop_bars", {
        type: "vector",
        url: "mapbox://stanronzhin.2li463nq",
      });
      ...
      map.current.addLayer(
        {
          ...
          type: "fill-extrusion",
          source: "pop_bars",
          "source-layer": "Lahore_Population_Bars_NO2_SO-9yq7ec",
          layout: {
            visibility: "none",
          },
          paint: {
      ...
      map.current.addSource("SO2", {
        type: "raster",
        url: "mapbox://stanronzhin.7ygc8jva",
      });
      ...
      map.current.addSource("NO2", {
        type: "raster",
        url: "mapbox://stanronzhin.21xiuu9e",
      });
      ...
      map.current.addSource("O3", {
        type: "raster",
        url: "mapbox://stanronzhin.1q0csj6x",
      });
      ...
      map.current.addSource("CO", {
        type: "raster",
        url: "mapbox://stanronzhin.7gvtjv7c",
      });
      ...
      map.current.addSource("PM10", {
        type: "raster",
        url: "mapbox://stanronzhin.8vkc5tig",
      });
      ...
      map.current.addSource("schools", {
        type: "vector",
        url: "mapbox://stanronzhin.0ezw1evq",
      });

      map.current.addLayer({
        id: "Schools",
        source: "schools",
        "source-layer": "Schools_Lahore-1nb538",
        minzoom: 0,
        maxzoom: 22,
        type: "circle",
        layout: {
      ...
      map.current.addSource("sa_schools", {
        type: "vector",
        url: "mapbox://stanronzhin.4ul8e5eq",
      });
      ...
      map.current.addLayer(
        {
          ...
          source: "sa_schools",
          "source-layer": "Schools_Service_Areas_Lahore-bwqoks",
          minzoom: 0,
          maxzoom: 22,
          type: "fill",
          paint: {
      ...
      map.current.addSource("transport_stops", {
        type: "vector",
        url: "mapbox://stanronzhin.dqiftd3c",
      });

      map.current.addLayer({
        id: "Transport stops",
        source: "transport_stops",
        "source-layer": "Transport_stops_Lahore-aaen85",
        minzoom: 0,
        maxzoom: 22,
        type: "circle",
        layout: {
      ...
      map.current.addSource("sa_transport", {
        type: "vector",
        url: "mapbox://stanronzhin.6x5dknm3",
      });

      map.current.addLayer({
        id: "Transport service areas",
        source: "sa_transport",
        "source-layer": "Transport_stops_Service_Areas-1pa8z6",
        minzoom: 0,
        maxzoom: 22,
        type: "fill",
        paint: {
      ...
      map.current.addSource("parks", {
        type: "vector",
        url: "mapbox://stanronzhin.86p6ieo9",
      });

      map.current.addLayer({
        id: "Parks",
        source: "parks",
        "source-layer": "Parks_Lahore-dhv0hq",
        minzoom: 0,
        maxzoom: 22,
        type: "fill",
        paint: {
      ...
      map.current.addSource("sa_parks", {
        type: "vector",
        url: "mapbox://stanronzhin.acruffzu",
      });
      ...
      map.current.addLayer(
        {
          ...
          source: "sa_parks",
          "source-layer": "Parks_Service_Areas_Lahore-7d82tk",
          minzoom: 0,
          maxzoom: 22,
          type: "fill",
          paint: {
      ...
      map.current.addSource("water", {
        type: "raster",
        url: "mapbox://stanronzhin.ch7ijt8a",
      });
      ...
      map.current.addSource("damagedLand", {
        type: "raster",
        url: "mapbox://stanronzhin.1dmi2te1",
      });
      ...
      map.current.addSource("green_areas", {
        type: "raster",
        url: "mapbox://stanronzhin.5pvdsq9h",
      });
