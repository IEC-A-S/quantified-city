...
export const ColorCube = () => {
  ...
  useEffect(() => {
    ...
    const materials = [
      ...
      new THREE.MeshStandardMaterial({ color: 0x00ff00 }), // Back
      new THREE.MeshStandardMaterial({ color: 0x0000ff }), // Top
      new THREE.MeshStandardMaterial({ color: 0xffff00 }), // Bottom
      new THREE.MeshStandardMaterial({ color: 0xff00ff }), // Right
      new THREE.MeshStandardMaterial({ color: 0x00ffff }), // Left
    ];
