        ...
        <div className={classes.root}>
            ...
            <ContentRow name="Initiator">
                <div style={{
                    ...
                    <RaitingBubble title="Contact initiator" style={{
                        color: "#ffffff",
                ...
                <div style={{
                ...
                }}>
                    {
                        projectData.Participation_options.split(", ").map((item) => {
                            return (
                                <RaitingBubble title={item} style={{
                                    color: "#000000",
            ...
            <RaitingBubble title="Download project" style={{
                color: "#ffffff",
                backgroundColor: "#000000",
                width: "fit-content",
                marginLeft: "18vw",
                ...
                <img src="/assets/projects_download_icon.svg" style={{
                    width: "2vh",
                    height: "2vh",
                    marginLeft: "1vh",
                }} />
